...
class ProfileHeader extends StatelessWidget {
  ...
  final VoidCallback? onEditCategories; // เปลี่ยนเป็น nullable
  ...
  const ProfileHeader({
    ...
    this.onEditCategories, // ✅ เปลี่ยนจาก required เป็น optional
          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                if (onEdit != null) // ✅ แสดงเฉพาะถ้ามี callback
                  SizedBox(
                    height: 36,
                    child: FilledButton(
                      onPressed: onEdit,
              ...
              children: [
                Row(
                  children: [
                    ...
                    const Spacer(),
                    if (onEditCategories != null) // ✅ ซ่อนไว้ถ้าไม่ส่ง callback
                      IconButton(
